...
1. Доступ к состоянию телефона - проверка доступности интернета для показа рекламных блоков

2. Доступ к контактам для таретированной рекламы



## Контакты

e-mail: xenol@list.ru
